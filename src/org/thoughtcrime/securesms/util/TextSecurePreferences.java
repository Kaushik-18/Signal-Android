...
public class TextSecurePreferences {
  ...
  private static final String NEEDS_OUTAGE_CHECK     = "pref_needs_outage_check";
  ...
  public static void setNeedsOutageCheck(Context context, boolean needsCheck) {
    setBooleanPreference(context, NEEDS_OUTAGE_CHECK, needsCheck);
  }

  public static boolean getNeedsOutageCheck(Context context) {
    return getBooleanPreference(context, NEEDS_OUTAGE_CHECK, false);
  }
